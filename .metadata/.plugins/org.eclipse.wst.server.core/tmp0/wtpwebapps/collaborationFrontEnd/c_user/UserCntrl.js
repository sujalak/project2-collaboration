myapp.controller("UserCntrl",function($scope,$http,$location,$rootScope,$cookieStore)
{
	...
	$rootScope.login=function()
	{
		...
		$http.post('http://localhost:8080/collaborationMiddleWare/login',$scope.user)
		...
		$scope.SignUpuser = function()
	{
		...
		$http.post('http://localhost:8080/collaborationMiddleWare/SignUp',$scope.user)
		.then(function(response)
     	{
	...
	$scope.uploadimage = function()
	{
		...
		$http.post('http://localhost:8080/collaborationMiddleWare/doUpload')
		.then(function(response)
     	{
